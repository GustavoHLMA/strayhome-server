...
exports.CampaignIdDTO = exports.UpdateCampaign = exports.Campaign = void 0;
...
exports.Campaign = zod_1.z.object({
    ...
    target: zod_1.z
        ...
        .min(0, { message: 'O alvo deve ser um valor positivo' }),
    startDate: zod_1.z
        .string({
        invalid_type_error: 'A data de início deve ser uma string',
        required_error: 'A data de início é obrigatória'
    })
        .refine(value => !isNaN(Date.parse(value)), { message: 'Data de início inválida' }),
    deadline: zod_1.z
        .string({
        invalid_type_error: 'A data de término deve ser uma string',
        required_error: 'A data de término é obrigatória'
    })
        .refine(value => !isNaN(Date.parse(value)), { message: 'Data de término inválida' }),
    creatorId: zod_1.z
        .string({
...
exports.CampaignIdDTO = zod_1.z.object({
    id: zod_1.z.string().uuid({ message: 'ID da campanha inválido' })
});
